...
| Updater restored — fork appcast + own Ed25519 key | `004-restore-updater-fork-appcast.patch` | `WinMuxApp.swift`, `AutomaticUpdates.swift`, `makefile`, `project.yml` | `dev.patch` |
